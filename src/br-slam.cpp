...
BytesSlam::BytesSlam() : Node("bytes_slam"), sync_(left_image_sub_, right_image_sub_, 10)
{
    left_image_sub_.subscribe(this, "stereo/left/resize/image");
    right_image_sub_.subscribe(this, "stereo/right/resize/image");
